...
export default function Product() {
    ...
    return (
        <>
            {/* Header */}
            <div className="bg-black mt-10 md:mt-30 p-4 text-white">
            ...
            <AnimatePresence>
                {showDrawer && (
                    ...
                    >
                        ...
                        <div className="right-0 bottom-20 left-0 absolute flex justify-between mt-4 p-4 border-t border-t-gray-300">
                            <button
                                onClick={handleClear}
